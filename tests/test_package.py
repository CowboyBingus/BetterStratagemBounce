...
def main():
    ...
    with zipfile.ZipFile(sys.argv[1]) as package:
        ...
        assert manifest['Name'] == 'Better Stratagem Bounce - v15.1'
        assert manifest['Options'] == [{'Name': 'Better Stratagem Bounce - v15.1', 'Description': manifest['Description'],
        ...
        assert provenance['revision'] == 'archive-v15.1' and provenance['runtime_verified'] is False
